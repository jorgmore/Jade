...
public class Explorador extends ObservableAgent {
	...
	public void setEncontradoMineral(boolean hay_mineral){
		this.hay_mineral = hay_mineral;
	}
	
	public boolean getEncontradoMineral(){
		return this.hay_mineral;
	}
